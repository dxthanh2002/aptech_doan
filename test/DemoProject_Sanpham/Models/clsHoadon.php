...
class clsHoadon
{
	...
	function ThemHoadon($hoten,$dtmua, $ngnhan, $dienthoai,$diachi,$note, $ngaynhan, $cusid)
	{
		$sql = "INSERT INTO tbHoadon(tennguoimua,dtnguoimua,nguoinhan,dienthoai,diachi,Note,ngaynhan,cusid) 
				VALUES(?,?,?,?,?,?,?,?)";
		$data[] = $hoten;
		$data[] = $dtmua;
		$data[] = $ngnhan;
