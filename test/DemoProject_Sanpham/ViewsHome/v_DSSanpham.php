				...
				?>
        			...
        			<div class=" d-grid gap-3 card text-center mt-5 p-3" style="width: 18rem;">
        				...
        				<div class="card-body">
        					...
        					<p class="card-text text-dark">Giá: <?= number_format($row["price"]) ?> VNĐ</p>
        					<i class="text-dark fa fa-shopping-cart me-3"></i> <a href="?module=cart&act=add&masp=<?= $row["id"] ?>" class="btn btn-primary"> Mua hàng</a>
        				</div>
        			</div>
