    ...
    <div class="contrainer text-white text-center text-md-start">
        <div class="row text-center text-md-start">
            ...
            <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
                <h5 class="text-uppercase mb-4 fw-bold text-warning">Usefullink</h5>
                <p>
                    <a href="#" class="text-white" style="text-decoration:none">Gift Cards</a>
                </p>
                <p>
                    <a href="#" class="text-white" style="text-decoration:none">Size Chart</a>
                </p>
                <p>
                    <a href="#" class="text-white" style="text-decoration:none">My Account</a>
                </p>
                <p>
            ...
            <div class="col-md-7 col-lg-8">
                <p>Copy right@ by:
                    <a href="#" style="text-decoration: none;">
                        <strong class="text-warning">Dxthanh</strong></a>
                </p>
            </div>
        </div>
    </div>
